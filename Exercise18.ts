let places_originals:string[] = ['K2 Base Camp', 'Amsterdam', 'Victoria Falls', 'Petra', 'Hawaii'];

// Original array
console.log("Original Order:", places_originals);

// Copy of the original places array
let places_sorted:string[] = places_originals.slice();
...
// Copy of the original places array
let places_reversed:string[] = places_originals.slice();
